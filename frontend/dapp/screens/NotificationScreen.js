...
import { View, Text, Button,StyleSheet,Alert,AsyncStorage,TouchableHighlight,ScrollView } from 'react-native';
             ...
             return (
                ...
                >
                  <View style={styles.reqContainer}>
                    <Text>Sent consent to : {ent.sentrequests.receivername}</Text>
                    <Text>Requested consent for {ent.sentrequests.preference}</Text>
